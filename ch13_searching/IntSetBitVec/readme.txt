...
使用“位向量”（第一章介绍过）实现“IntSetBitVec”。

notes:
m=500000, n=10000000, Cost time: 0.91 seconds
m=1000000, n=10000000, Cost time: 1.69 seconds 
...
notes:
m=50000, n=10000000, Cost time: 0.11 seconds
m=100000, n=10000000, Cost time: 0.22 seconds 

**********
生成[0, maxval]范围内m个随机整数的有序序列，不允许重复。
使用链表实现IntSetListNoRecursion(链表insert"不"使用递归函数).

notes:
m=50000, n=10000000, Cost time: 10.93 seconds 
m=100000, n=10000000, Cost time: 59.62 seconds
